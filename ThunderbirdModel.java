...
class ThunderbirdModel extends HttpRequest {
    ...
    //updated the URL link to our class URL link for JSON files - DP
            ...
            for (String line : urlContent) {
                ...
                if (subString.length >= 11) {
                    if (subString[11].indexOf("https://") > -1) {
                        ...
                        //     added.  - didn;t understand this TODO -dp
                        returnValue = true;
                    }
                }
            }            
    ...
    public void LoadContactsThreaded() {
        ...
        ArrayList<Thread> threadList = new ArrayList<Thread>(); //array of thread
        for (ThunderbirdContact hrC : contactList) {
            threadList.add(new Thread(hrC)); // adding contacts (threads)
        }        
